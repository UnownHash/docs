...
| Key | Default | Description |
| :-- | :-- | :-- |
| `required_level` | 30 | (Advanced) Minimum account level required to be used for scanning/questing. This only accepts level 30 or 31. |
| `leveling_level` | 30 | (Advanced) Maximum level an account should reach during the leveling process. This only accepts level 30 or 31. |
