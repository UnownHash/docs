...
1. Login to your Dragonite Admin dashboard [http://SERVER_YOUR_IP:7273]() (by default).
1. Switch to the **Proxies** tab in the sidebar
1. Add a few http proxies in the following example format. If you have authentication for your proxy use the following
